...
- **Normalization (Min-Max Scaling)**: This technique rescales features to a specific range, typically [0, 1].
- **Standardization (Z-Score Normalization)**: This method transforms features to have a mean of 0 and a standard deviation of 1.
